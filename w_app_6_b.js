...
// ii) Filter with Regular Expression

// When using regular expressions in MongoDB queries, what type of fields can they be used to query?
// Only string fields
...
async function createCollection() {
    try {
        ...
        const inserted = await dbo.collection("customers").find(query).toArray();
